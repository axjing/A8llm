...
from xlm.common.tokenizer import RustBPETokenizer, get_tokenizer
from xlm.data.get_datasets import parquets_iter_batched
...
tokenizer_results: dict[str, dict[str, dict[str, int | float]]] = {}
...
for tokenizer_name in ["gpt2", "gpt4", "ours"]:
    ...
    for name, text in all_text:
        encoded = cast(list[int], tokenizer.encode(text))
